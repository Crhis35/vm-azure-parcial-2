...
INSERT INTO `admin` (`id`, `username`, `password`, `email`, `date`)
VALUES (
        1,
        'Admin',
        '$2y$10$FfhPYubR4sOXAFSd3NzyQ.C77L4.qIsCa/YlYZCn.2eK8rfWr6oiq',
        'admin@example.org',
        '2021-09-19 14:39:53'
    );
-- --------------------------------------------------------
